#define ACCOUNT_LOCAL   1
#define ACCOUNT_NETWORK 2
...
/datum/extension/interactive/ntos/proc/get_access(var/mob/user)
	. = list()
...
/datum/extension/interactive/ntos/proc/get_account(var/mob/user)
	if(!current_account)
		return null
...
/datum/extension/interactive/ntos/proc/get_account_nocheck()
	return current_account?.resolve()

/datum/extension/interactive/ntos/proc/login_account(var/new_login, var/new_password, var/mob/user)
	var/datum/computer_network/network = get_network()
...
/datum/extension/interactive/ntos/proc/logout_account(var/mob/user)
	var/datum/computer_file/data/account/check_account = current_account?.resolve()
	if(check_account)
		check_account.logged_in_os -= weakref(src)
...
/datum/extension/interactive/ntos/proc/login_prompt(var/mob/user)
...
/datum/extension/interactive/ntos/proc/mail_received(datum/computer_file/data/email_message/received)
